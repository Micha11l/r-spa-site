...
export const SPA = [
  ...
  "Spa – Full Body (90m)",
  "Lymphatic Drainage Massage (90m)",
  "Foot Massage (45m)",
] as const;
...
export const DURATIONS: Record<ServiceName, number> = {
  ...
  "Lymphatic Drainage Massage (90m)": 90,
  "Foot Massage (45m)": 45,
...
export const PRICES: Record<ServiceName, number> = {
  // Therapies
  "Seqex Session (27m)": 50,
  "Seqex Session – Double (58m)": 95,
  "Seqex Personalized Test (80m)": 120,
  "Personalized Test & Card (80m)": 120,
  "ICR Treatment (12m)": 30,
  "Amygdala Flush (custom)": 80,
  "Special Treatment (custom)": 80,
  "RX1 Seat (20m)": 40,
  "Vitamin D UVB (4m)": 20,
  "LifeForce (60m)": 100,
  ...
  // Spa & Massage
  "Spa – Head (45m)": 110,
  "Spa – Back & Shoulders (60m)": 130,
  "Spa – Full Body (90m)": 160,
  "Lymphatic Drainage Massage (90m)": 160,
  "Foot Massage (45m)": 90,

  // Other
  "Private Event / Party (inquiry only)": 0,
};
